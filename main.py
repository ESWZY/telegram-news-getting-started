...
ie1.set_list_selector('body > div.inner_page > ul > li') #id_ul_li
ie1.set_title_selector('body > div.inner_page > ul > li')  #id
ie1.set_paragraph_selector('body > div.inner_page > ul > li > a')
